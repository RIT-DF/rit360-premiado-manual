---
title: "Requisitos legais de um sorteio"
nav_order: 4
parent: "Boas práticas & campanhas vencedoras"
permalink: /boas-praticas/requisitos-legais/
source_docs: [PRD_Bussola_Premiada.md]
...
>
> Esta página é uma orientação geral, **não** é aconselhamento jurídico. A responsabilidade pela regularidade da campanha é **sempre da organização promotora**. Antes de lançar, consulte um profissional e verifique as exigências aplicáveis ao seu caso. Veja o [Aviso legal](/legal/aviso/).
...
- **Prestação de contas** com checklist de documentos (ata de apuração, recibo de entrega, comprovante do prêmio) e relatórios exportáveis. Veja [Prestar contas](/guias/prestar-contas/).
