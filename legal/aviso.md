...
- **Não é um meio de pagamento.** O checkout e o processamento financeiro são do **WooCommerce**, com o meio de pagamento configurado pela própria organização.
- Os indicadores, checklists e modelos são **materiais de apoio de caráter geral** e **não constituem aconselhamento jurídico**.

A **responsabilidade** pela regularidade da campanha, pela veracidade das informações e pela entrega do prêmio é **integralmente da organização promotora**. A **RIT** e a **[V3RTECH](https://v3rtech.com.br/){:target="_blank" rel="noopener"}** atuam apenas como **fornecedoras da ferramenta**.

> 📄 **Este é um resumo.** As condições completas estão nos **[Termos de Uso](/legal/termos/)**; o tratamento de dados, na **[Política de Privacidade](/legal/privacidade/)**.
