...
A GPL garante quatro liberdades sobre o software:

- **Usar** o programa para qualquer finalidade.
- **Estudar** como ele funciona e **adaptá-lo** às suas necessidades (o acesso ao código-fonte é condição para isso).
- **Redistribuir** cópias.
...
> ⚠️ **Importante**
>
> Conforme a GPL, o programa é distribuído **"NO ESTADO EM QUE SE ENCONTRA" (AS IS), SEM QUALQUER GARANTIA** — expressa ou implícita —, inclusive quanto a comercialização ou adequação a uma finalidade específica. Todo o risco quanto à qualidade e ao desempenho do programa é de quem o utiliza. Veja também os [Termos de Uso](/legal/termos/) e o [Aviso legal](/legal/aviso/).

## Texto completo da licença

O texto integral e oficial da GPL está disponível em:
...
- Tradução não oficial em português — [https://www.gnu.org/licenses/translations.html](https://www.gnu.org/licenses/translations.html)
...
> 💡 Se você aprecia o projeto e quer apoiar sua continuidade, veja [Apoiar a RIT](/guias/apoiar-a-rit/). O apoio é sempre voluntário — a licença GPL não exige contrapartida financeira.
