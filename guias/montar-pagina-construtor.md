...
Se você quer um layout próprio — diferente da página pública pronta —, pode montar a página da campanha no **editor de blocos (Gutenberg)** ou em construtores como o **Elementor**, combinando os componentes da Bússola Premiada. Disponível a partir da versão **1.5.0**.
...
2. Clique em **adicionar bloco** (o “+”) e procure por **“Bússola”**.
3. Escolha um componente na categoria **Bússola Premiada** — por exemplo, **Seleção de cartões**, **Painel de transparência**, **Barra de progresso**, **Botão comprar**, **Compartilhamento** ou a **Rifa completa**.
...
```
[bussola_premiada_painel id="12"]
[bussola_premiada_selecao id="12"]
[bussola_premiada_compartilhar id="12"]
```
